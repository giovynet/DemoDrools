...
public class AppStateless {
	...
	public static void main(String[] args) {
		...
		StatelessKieSession kieSession = kContainer.newStatelessKieSession("ksession-stateless-opportunity");
		...
		lstPerson.add(new Person(2L, "Dulcinea del Toboso", new BigDecimal(5000.00), new BigDecimal(3750.00), true));
